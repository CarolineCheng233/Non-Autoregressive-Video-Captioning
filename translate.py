...
def prepare_collect_config(option, opt):
    ...
    filename = '_'.join(names + [opt.pretrain, opt.language, opt.form] + [parameter])
...
def main():
    ...
    parser.add_argument('-lang', '--language', type=str, choices=['ch', 'en'])
    parser.add_argument('-form', '--form', type=str, choices=['word', 'char'], default='word')
